package com.lumberwizard.redstoneigniter.compat;

import com.lumberwizard.redstoneigniter.BlockIgniter;
...
public class WailaCompatibility implements IWailaDataProvider {
    ...
    public static void load(IWailaRegistrar registrar) {
        ...
        if (!loaded){
            registrar.registerHeadProvider(INSTANCE, BlockIgniter.class);
            registrar.registerBodyProvider(INSTANCE, BlockIgniter.class);
            registrar.registerTailProvider(INSTANCE, BlockIgniter.class);
            loaded = true;
        }
    }
    ...
    public static void register() {
        ...
        registered = true;
        FMLInterModComms.sendMessage("waila", "register", "com.lumberwizard.redstoneigniter.compat.WailaCompatibility.load");
    }
